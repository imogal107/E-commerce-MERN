...
const SignUpPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      >
        <h2 className="mt-6 text-center text-3xl font-extrabold text-cyan-500">
          Create your account
        </h2>
      </motion.div>
      <motion.div
      ...
      >
        <div className="relative bg-gray-900/30 py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <User
                    className="h-5 w-5 text-gray-6=400"
                    aria-hidden="true"
                  />
                </div>
                <input

...
const ProductReviewSection = ({ product }) => {
  return (
    <div className="grid grid-row-12 col-span-12 gap-2 border border-cyan-700/30 h-48 rounded bg-black/10 shadow-white/50 shadow-xs md:p-2 text-xs md:text-md lg:text-lg">
      <div className="flex col-span-2  justify-center items-center p-1">
        <p>★★★★★</p>
      </div>
      <div className="flex col-span-10 justify-center items-start p-1 overflow-y-scroll hide-scrollbar">
        <p>
